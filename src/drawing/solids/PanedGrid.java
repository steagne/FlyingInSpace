        ...
        for (y = 0; y < numberOfStacks; y++)
        {
            for (x = 0; x < numberOfSectors; x++)
            {
                tmpVertices = new Vertex[]{
                        new Vertex(FUV(x, y), new Vector3f(), new Vector2f(0, 0)),
                        new Vertex(FUV(x, y + 1), new Vector3f(), new Vector2f(0, 1)),
                        new Vertex(FUV(x + 1, y + 1), new Vector3f(), new Vector2f(1, 1)),
                        new Vertex(FUV(x + 1, y), new Vector3f(), new Vector2f(1, 0))
                };
